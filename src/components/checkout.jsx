...
const Checkout = ({ match, history }) => {
  ...
  const makePayment = () => {
    ...
    alert("project details saved, you can make payment now");
    ...
    <>
      ...
      {hidePaypal ? (
        ...
        <Container className=" CheckoutContainer  mb-5">
          ...
          <Row className="d-flex gap-5 px-4 my-5">
            ...
            {showPaymentDiv && (
              <Col className=" CheckoutBox p-3">
                ...
                <div>
                  {checkout ? (
                    <PayPal paymentDetails={paymentDetails} setHidePaypal={setHidePaypal} project={project} bidder={bidder} price={price} projectDetails={projectDetails} />
                  ) : (
                    <Button
                      onClick={() => {
                        setCheckOut(true);
